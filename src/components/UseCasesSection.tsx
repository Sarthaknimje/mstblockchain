          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between relative z-10">
                ...
                <span className={`text-[8px] font-black uppercase tracking-[0.2em] ${colorScheme.text}`}>
                  {uc.num}
                </span>
              </div>

              <div className="relative z-10">
                <h4 className="text-[11px] font-black uppercase leading-tight mb-1.5 group-hover:text-primary transition-colors">
                  {uc.title}
                </h4>
