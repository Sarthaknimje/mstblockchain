...
const ValidatorSection = () => (
  <section className="py-16 md:py-28 section-border bg-background overflow-hidden relative">
    ...
    <div className="max-w-[1440px] mx-auto relative">
      ...
      >
        <div className="w-64 h-64 rounded-full border border-primary/10 flex items-center justify-center">
          <Radar className="w-10 h-10 text-primary/15" strokeWidth={1} />
        </div>
      </motion.div>
      <motion.div
      ...
      >
        <div className="w-64 h-64 rounded-full border border-primary/10 flex items-center justify-center">
          <Waves className="w-10 h-10 text-primary/15" strokeWidth={1} />
        </div>
      </motion.div>
      ...
      <ScrollReveal>
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto py-14 md:py-20 border-2 border-foreground/20 bg-background z-10 relative px-6 md:px-8 overflow-hidden">
          ...
          <h2 className="text-3xl md:text-5xl font-black tracking-tighter mb-4 uppercase relative z-10">
            Join <span className="primary-gradient-text">69,000+</span> Validators
          </h2>
          <p className="text-sm md:text-lg font-medium mb-6 px-4 md:px-12 text-on-surface-variant relative z-10">
            Help secure the MST network using Proof of Staked Authority consensus.
          </p>

          <div className="flex flex-wrap justify-center gap-4 mb-8 relative z-10">
            {[
              { label: "Active Validators", value: "69,000+", gradient: "from-emerald-500/15 to-teal-500/5", border: "border-emerald-500/30" },
              { label: "Network Uptime", value: "99.99%", gradient: "from-cyan-500/15 to-blue-500/5", border: "border-cyan-500/30" },
              { label: "Block Time", value: "3 sec", gradient: "from-violet-500/15 to-purple-500/5", border: "border-violet-500/30" },
            ].map((s) => (
